...
export default function MedicalResearch() {
  const images = [
    ...
    { src: '/images/workshop-2.jpeg', alt: 'Workshop 2' },
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-gray-100 text-center fade-in">
        ...
        <ul className="max-w-3xl mx-auto text-lg list-disc list-inside mb-4 text-left">
      ...
      <section className="py-16 text-center fade-in bg-gray-100">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {images.map((image, index) => (
            <div key={index} className="relative w-full h-80 bg-white p-4 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out">
              <Image
                src={image.src}
                alt={image.alt}
                layout="fill"
