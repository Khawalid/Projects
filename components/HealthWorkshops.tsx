      ...
      <section className="py-12 bg-gray-100 text-center fade-in">
        ...
        <div className="flex flex-col md:flex-row items-center justify-around px-4">
          ...
          <div className="max-w-lg text-xl font-extrabold">
            <p className="mb-4">“My passionate mentor continuously guided me to conclude my research project. It was an amazing journey full of learning and now I feel that I am capable to manage future Assignments independently.”</p>
          </div>
        </div>
